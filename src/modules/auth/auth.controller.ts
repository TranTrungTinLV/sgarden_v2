...
export class AuthController {
  ...
  @ApiOperation({ summary: 'Quên mật khẩu nó sẽ newPassword về email', description: 'Gửi yêu cầu đặt lại mật khẩu' })
  @ApiConsumes('multipart/form-data')
  @ApiBody({
    schema: {
      type: 'object',
  ...
  @Public()
  @Post('reset-password')
  @ApiOperation({ summary: 'Quên mật khẩu nhập newPassword đó và email vừa gửi', description: 'Gửi yêu cầu đặt lại mật khẩu' })
  @ApiBody({
    schema: {
      type: 'object',
      properties: {
